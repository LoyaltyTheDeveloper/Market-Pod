...
function UserDetails() {
  ...
  const isFormOne = formOne.field1.trim() !== "" && formOne.field2.trim() !== "";
    ...
    <div className="pt-[80px] min-h-screen">
        <div className="flex flex-col lg:flex-row">
            ...
            <div className="px-4">
              ...
              <div>
        <button
          className={`px-2 py-3 lg:px-8 rounded-r-[30px] ${
            activeButton === 'button1' ? 'bg-[#31603D] text-white' : ''
          }`}
        ...
        <button
          className={`px-2 py-3 lg:px-8 rounded-r-[30px] ${
            activeButton === 'button2' ? 'bg-[#31603D] text-white' : ''
          }`}
...
<h1 className="font-bold text-[24px]">Name</h1>
          ...
          disabled={!isFormOne}
          className={`w-full py-4 px-4 rounded-[100px] text-white font-bold ${
            isFormOne ? "bg-[#31603D]" : "bg-[#31603D] opacity-60 cursor-not-allowed"
          }`}
        >
          Update Changes
        </button>
...
<h1 className="font-bold text-[24px]">Phone</h1>
          ...
          disabled={!isFormTwo}
          className={`w-full py-4 px-4 rounded-[100px] text-white font-bold ${
            isFormTwo ? "bg-[#31603D]" : "bg-[#31603D] opacity-60 cursor-not-allowed"
          }`}
        >
          Update Changes
        </button>
